...
for i in 1 2 3 4 5; do
  ...
  for j in md1 md2 md3 md4 md5 md6 md7 md8 md9 md10 md11 md12 md13 md14 md15 md16 md17 md18 md19 md20; do
    echo "trajin ./closed_${i}_${j}.nc" >> analysis_traj_${i}.in
  done
...
strip :Na+
strip :Cl-
trajout ../closed_dry_${i}.nc
run
clear all
parm ../closed10_dry.parm7
reference ../open10_dry.rst7
trajin ../closed_dry_${i}.nc
rms reference out ../closed_rmsd_to_open_${i}.dat '(!:WAT & @CA,C,N,O)'
run
clear all
parm ../closed10_dry.parm7
reference ../closed10_dry.rst7
trajin ../closed_dry_${i}.nc
rms reference out ../closed_rmsd_to_closed_${i}.dat '(!:WAT & @CA,C,N,O)'
run
