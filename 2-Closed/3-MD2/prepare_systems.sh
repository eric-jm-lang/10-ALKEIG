...
for name in min1 min2 min3 min4 min5 min6 ; do
 mpirun -n 28 \$AMBERHOME/bin/pmemd.MPI -O -i \$name.i -o closed_${i}_\$name.mdout -p closed10_HMR.parm7 -c closed_${i}_\$old.rst7 \
...
for name in heat ; do
 \$AMBERHOME/bin/pmemd.cuda -O -i \$name.i -o closed_${i}_\$name.mdout -p closed10_HMR.parm7 -c closed_${i}_\$old.rst7 \
  -ref closed_${i}_min6.rst7 -x closed_${i}_\$name.nc -r closed_${i}_\$name.rst7 -inf closed_${i}_\$name.mdinfo
...
cd \$MYDIR
old=min6
for name in heat eq1 eq2 eq3 eq4 eq5 eq6 eq7 eq8; do
 \$AMBERHOME/bin/pmemd.cuda -O -i \$name.i -o closed_${i}_\$name.mdout -p closed10_HMR.parm7 -c closed_${i}_\$old.rst7 \
  -ref closed_${i}_min6.rst7 -x closed_${i}_\$name.nc -r closed_${i}_\$name.rst7 -inf closed_${i}_\$name.mdinfo
