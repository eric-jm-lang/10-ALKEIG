...
&cntrl
 ...
 ntpr=500, ntwx=500, 		! Write the trajectory every 50 ps and the energies every 10 ps
 ioutfm=1,		           	! Use Binary NetCDF trajectory format (better)
 iwrap=0, 		          	!  wrapping will be performed
 ntxo=1, 			            ! NetCDF file
 ntwr=-50000,		         	! Write a restrt file every 500 ps , if negative value, the files are not overwritten
 ...
 tgtrmsd=0.85,             ! Value of the target RMSD 
 tgtmdfrc=0.1,              ! Value of the force constant 
