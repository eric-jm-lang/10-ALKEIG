...
echo "parm open10.parm7" >> analysis_traj_2.in

for i in 1 2 3 4 5; do
  for j in md1 md2 md3 md4 md5 md6 md7 md8 md9 md10 md11 md12 md13 md14 md15 md16 md17 md18 md19 md20; do
    echo "trajin ./${i}/open_${i}_${j}.nc" >> analysis_traj_2.in
  done 
done 
...
trajout open_all_dry_fit2closed.nc
run
clear all
parm open10_dry.parm7
...
trajout open_all_dry_fit2open.nc
run
clear all 
parm open10_dry.parm7
reference closed10_dry.rst7
trajin open10_dry.rst7
rms reference xray_open_rmsd_to_closed.dat '(!:WAT & @CA,C,N,O)'
